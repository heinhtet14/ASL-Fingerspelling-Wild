...
class Scorer(object):
    ...
    def get_score(self, string):
        ...
        #string_idx = list(map(lambda x: self.vocab_map[x], string))
        string_idx = [self.vocab_map[x] for x in string]
